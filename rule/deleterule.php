<?php
	...
	if(!$rule_info['delete']) {		#check projectAcl
	...
	<tr>
		<td>
			<table class="insidecontents" width="90%"  align="center" border="0">
				...
				<tr bgcolor="#80BBFF">
					<td align="center" colspan="8">Delete Rule<input type="hidden" name="rule_id" value="7"></td>
				</tr>
				<tr class="odd">
					<td class="message" colspan="8"><?php echo $message; ?><br /><br /></td>
				</tr>
				<tr class="odd"></tr>
				<tr class="even">
...
<?php
	echo '
					<form name= "deleterule" action = "'.$action['deleterule'].'&rule_id='.$rule_id.'" method="POST">
					<td width="5%"><b>'.$rule_info['rule_id'].'</b></td>
			...
			<table class="insidecontents" width="90%" align="center" border="0">
				<tr>
					<td align="left">
						...
						<input type="button" name="cancel" value="Cancel" onClick="window.location='<?php echo $action['editrules']; ?>'"><br /><br />
					</td>
					</form>
				</tr>
			</table>
