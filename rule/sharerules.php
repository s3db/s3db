...
include_once('../core.header.php');
	...
	if ($acl == '3')
		...
		echo "<tr bgcolor='#80BBFF'><td colspan='9' align='center'>Request a connection to a resource</td></b>";
		echo "</tr><td><BR></td>";
		echo "<tr><td bgcolor='#FFFFCC'>Please insert the intended rule ID </td></tr>";
		echo "<tr><td><form name='connect_UID' action='sharerules.php?key=".$key."&project_id=".$_REQUEST['project_id']."' method='POST'>";
		echo '<input name="rule_id" type="text"><sup>*required</sup>';
		echo "<tr><td bgcolor='#FFFFCC'>Please enter a short description for the reason to connect</td></tr>";
		echo '<tr><td><textarea name="notes" style="background: lightyellow" rows="3" cols="60"></textarea><BR><BR></td></tr>';
		echo '<tr><td><input type="submit" name="connect" value="Submit"></td></tr></table>';
...
//						{
//						
//						$entry = Array ('project_id' => $_REQUEST['project_id'],
//							'account_id' => $user_id,
