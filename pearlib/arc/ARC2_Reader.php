...
version:  2008-07-14 (Fix: readStream considers content-length header and adjusts d_size)
*/
...
class ARC2_Reader extends ARC2_Class {
  ...
  function readStream($buffer_xml = true, $d_size = 1024) {
    if (!$s = $this->v('stream')) return $this->addError('missing stream in "readStream"');
