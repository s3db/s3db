...
version:  2008-07-15 (Addition: ARC2_SGAJSONParser
                      Addition: ARC2_StoreSGAJSONLoader
                      Addition in ARC2_getFormat
                      Addition in ARC2_RDFParser
                      Addition in ARC2_StoreLoadQueryHandler
                      Fix in ARC2_Reader
                      Tweak in ARC2_SPARQLParser
                      Addition in ARC2_SPARQLScriptProcessor
                      Additon in ARC2_SPARQLScriptParser
                      Tweak in ARC2_Store
                      Addition in ARC2_TurtleParser
                      Tweak in ARC2_RemoteStore)
*/
...
class ARC2 {
  ...
  function getSPARQLScriptParser($a = '') {
    return ARC2::getComponent('SPARQLScriptParser', $a);
  }
