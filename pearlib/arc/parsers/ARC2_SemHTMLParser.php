...
version:  2008-06-13 (Tweak: Added support for "keep_cdata_whitespace" config option)
*/
...
class ARC2_SemHTMLParser extends ARC2_LegacyXMLParser {
  ...
  function extractRDF($formats = '') {
    ...
    $formats = !$formats ? $this->v1('sem_html_formats', 'erdf rdfa dc openid hcard-foaf hcalendar xfn rel-tag-dc', $this->a) : $formats;
