<?php
	...
	function display($x) {		#x is the data to be displayed and the format
			...
			if($format=='html.pretty') {
				...
				<!--
					function paintRows() {
						...
						for (i=1; i<lines.length; i=i+2) {lines[i].style.backgroundColor = \'lightyellow\'};
					}
				//-->
				</script>';
			...
			if($format=='html.pretty') {
				...
				<!--
					function paintRows() {
						...
						for (i=1; i<lines.length; i=i+2) {lines[i].style.backgroundColor = \'#FFFFFF\'};
					}
				//-->
				</script>';
				echo '<body onload = paintRows()>';
