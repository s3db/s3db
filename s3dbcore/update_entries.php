<?php
	...
	function update_user($U) {		#update_user changes the entry on the table. 
	...
	function update_group($G) {		#updates account table where group_id specified. $G needs inputs, group_id, user_id and $db
		extract($G);
	...
	function update_requests($match, $field, $new_value, $db) {		#match = compact('rule_id', 'project_id');
