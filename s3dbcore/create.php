<?php
		...
		if($resource_id_created)
			{
				...
				$rule_info = Array('project_id'=>$resource_info['project_id'],
				 'owner'=>$user_id,
				...
				#INSERT LINE ON STATEMENTS TABLE - deprecated, will keep instances in resource
				{
				$statement_info = array('project_id'=>$resource_info['project_id'],
	...
	{#create group is a fucntion to take in group information and creaate a group
		...
		if($inserted_user)
		{
			...
			#echo '<pre>';print_r($newgroup['selected_users']);
