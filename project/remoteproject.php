...
<table class="middle" width="100%"  align="center">
	<tr><td>
		<table class="insidecontents" width="<?php echo $content_width ?>"  align="center" border="0">
			...
			<tr><td colspan="4" align="left">Remote projects are projects that exist in other deployments of S3DB. Specify a remote project either by concatenating deployment_id and project_id (for example, D45/P33) or by concatenating URL with project_id (http://s3db.org/P4)</td></tr>
			<tr class="odd">
