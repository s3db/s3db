		...
		<tr>
			<td>
				<table class="insidecontents" width="80%" align="center" border="0">
					...
					<tr bgcolor="#80BBFF">
						<td colspan="4" align="center">Edit Project</td>
					</tr>
					<tr class="odd">
						<td class="info" width="20%">Project Name</td>
						<td><input name="project_name" style="background: lightyellow"  value= "<?php echo $project_info['project_name'] ?>">&nbsp;</td>
...
?>
					<tr bgcolor="#80BBFF">
						<td colspan="4" align="center">Add other users to the list</td>
					</tr>
					<tr class="even">
