...
<table class="middle" width="100%"  align="center">
	<tr><td>
		<table class="insidecontents" width="100%"  align="center" border="0">
			<tr bgcolor="#80BBFF"><td colspan="2" align="center">Delete Project</td></tr>
			<tr class="odd">
				<td class="info">Removing the project will affect all rules, classes, instance and statements therein. 
				<b>Select "unlink" to remove yourself from project but leaving it for other users; Select "delete" to remove the project but leave dependencies for other users. Select "Delete with all dependencies" if your intention is to remove project, rules, classes and all dependencies.</b></td>
				
				<td><select name="flag" size="5">
			...
			<tr>
				<td><input type="button" name="back" value="Cancel" onClick="window.location='<?php echo $action['project']?>'">&nbsp;&nbsp;&nbsp;&nbsp;
