	...
	<tr><td>
		<table class="insidecontents" width="80%" align="center" border="0">
			...
			<tr class="odd">
				...
				<td><input name="project_name" style="background: lightyellow"  value= "<?php echo $project_name ?>">&nbsp;
				</td>
			...
			if($datagrid!='')
			{
				echo '<tr bgcolor="#80BBFF"><td colspan="4" align="center">Users that share groups</td></tr>';
				echo '</tr><tr><td class="info" colspan="4">'.$datagrid.'&nbsp;</td></tr>';
			}
			?>
			<td><br /><input type="submit" name="create_project" value="Create Project">
			</td></tr>
		</table>
