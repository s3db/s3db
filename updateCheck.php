<?php
	/*
	 * selfUpdate.php is the opposite function of supdates.php. Its purpose is to retrieve the RSS feed 
	 * of updated files from the mothership and download the files into the appropriate locations.
	 * 
