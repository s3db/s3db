...
<?php
		echo '
	<form action="'.$action['deletestatement'].'" method="post" autocomplete="on">
		<table border="0">
        	<tr>
				<td>Deleting statement #'.$statement_info['statement_id'].'</td>
				<td align="right"><font color="red"><b>'.$instance_info['notes'].'</b></font></td>
			</tr>
		</table>
		<table>
			<tr>
        ...
        echo '
        	<tr>
				<td><input type="submit" name="delete_statement" value="&nbsp;&nbsp;Delete&nbsp;&nbsp;"></td>
			</tr>
		</table>
	</form>';
	}
