<?php
	...
	function modelInfoRDF($element, $model, $rTmpId, $resources,$uidReLoad) {
		...
		switch ($element) {
			case 'user':
				$data_vars = array(
								'login'=>new Resource('http://www.w3.org/2000/01/rdf-schema#label'), 
			...
			case 'collection':
				$data_vars = array(
								'project_id'=>new Resource('http://www.w3.org/2000/01/rdf-schema#subClassOf'), 
								'name'=>new Resource('http://www.w3.org/2000/01/rdf-schema#label'), 
			...
			case 'item':
				$data_vars = array(
								'collection_id'=>new Resource('http://www.w3.org/1999/02/22-rdf-syntax-ns#type'), 
			...
			case 'statement':
				$data_vars = array(
								'item_id'=>new Resource('http://www.w3.org/1999/02/22-rdf-syntax-ns#subject'), 
