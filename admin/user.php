	...
	<tr>
		<td>
			<table class="insidecontents" align="center" width="80%">
				<tr>
					<td class="message"><br /><br /><?php echo $message ?></td>
				</tr>
				<tr align="center">
					<td colspan="2" class="current_stage"></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td>
			<table class="insidecontents" width="80%" align="center">
				<tr align="left">
					<td><?php echo $inactive_user_link ?></td>
				</tr>
	...
	<tr>
		<td>
			<table class="insidecontents" width="80%"  align="center">
				<tr>
					<td align="left">
						<input type="button" name="newuser" value="New User Account" onClick="window.location='<?php echo $action['createuser']; ?>'">
