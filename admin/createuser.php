<?php
	...
	if($_POST['submit'])
	{
		...
		$s3ql['where'] = array('account_lid'=>$_POST['account_lid'],
...
//	}
	...
	foreach ($groups as $group_info) {
		if($group_info['account_id']=='3')	$selected = " selected";
		else {
			$selected = "";
		}
...
<table class="middle" width="100%"  align="center">
	...
	<tr><td>
		<table class="insidecontents" width="<?php echo $content_width ?>"  align="center" border="0" width="100%"  align="center">
			<tr bgcolor="#80BBFF"><td colspan="4" align="center">
			Inherit permisions
			</td></tr>
			...
			<tr class="even">
				<td>
				<input type="checkbox" name="give_access">Give access
				
				</td>
				<td align="center"> 
				Filter:
				 <input type="text" name="permission_level" value="NNN">
				</td>
				<td>
				</td>
			</tr>
