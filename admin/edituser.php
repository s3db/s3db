<?php
	...
	if($_POST['submit']) {
		...
		} elseif($_POST['account_pwd']!='' && $_POST['account_pwd_2'] =='') {		#check if pass1 = pass2
				$password2_required='*';
			...
			<tr>
				<td>
					<table class="insidecontents" width="80%"  align="center" border="0">
						<tr bgcolor="#80BBFF">
							<td colspan="4" align="center">Edit User Account</td>
						</tr>
						<tr class="odd">
			...
			<tr>
				<td>
					<table id="other_authentications" class="insidecontents" width="80%"  align="center" border="0">
						<tr bgcolor="#80BBFF">
							<td colspan="4" align="center">Other authentication credentials</td>
						</tr>
<?php
...
?>
					...
					<table class="insidecontents" width="80%"  align="center" border="0">
						...
						<tr bgcolor="#80BBFF">
							<td colspan="4" align="center">New authentication method</td>
						</tr>
						<tr>
							<td bgcolor='#DDF0FF'>
			...
			<tr>
				<td>
					<table class="insidecontents" width="80%"  align="center">
						<tr>
							<td align="left">
								<input type="submit" name="submit" value="Update User Account" />&nbsp;&nbsp;&nbsp;&nbsp;
<?php 
	#if($user_info['account_group']=='a') {
