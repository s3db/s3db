		...
		<tr>
			<td>
				<table class="insidecontents" width="<?php echo $content_width ?>"  align="center" border="0">
					...
					<tr>
						<td colspan="4" align="left">Remote users are users that exist in other deployments of S3DB and need to access data on this deployment. Specify a remote user either by concatenating deployment_id and user_id (for example, D45/U33) or by concatenating URL with user_id (http://s3db.org/U4)</td>
					</tr>
					<tr class="odd">
