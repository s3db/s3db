...
<table class="middle" width="100%"  align="center">
	<tr><td>
		<table class="insidecontents" width="<?php echo $content_width ?>"  align="center" border="0">
			<tr bgcolor="#80BBFF"><td colspan="2" align="center"><?php echo $delete_message ?><input type="hidden" name="account_id" value="<?php echo $account_id ?>"></td></tr>
			<tr class="odd">
...
<table class="bottom" width="100%"  align="center">
	...
	<tr><td align="left"><?php echo $action_button  ?><br /><br /></td></tr>
	</table>
	</td></tr>
</form>
</table>
