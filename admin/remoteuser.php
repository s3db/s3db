...
<table class="middle" width="100%"  align="center">
	<tr><td>
		<table class="insidecontents" width="<?php echo $content_width ?>"  align="center" border="0">
			...
			<tr><td colspan="4" align="left">Remote users are users that are have account in places as diverse as Google, LDAP directory or even in another deployment of S3DB. User URI has the following syntax<BR><b><i>protocol</i>: <i>authority</i>: <i>username or email.</i></b></td></tr>
			<tr class="odd">
