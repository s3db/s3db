...
<table class="middle" width="100%"  align="center">
	<tr><td>
		<table class="insidecontents" width="<?php echo $content_width ?>"  align="center" border="0">
			<tr bgcolor="#80BBFF"><td colspan="7" align="center"><?php echo $edit_message ?><input type="hidden" name="account_id" value="<?php echo $account_id ?>"><input type="hidden" name="account_lid" value="<?php echo $account_lid ?>"></td></tr>
...
<table class="bottom" width="100%"  align="center">
	...
	<tr><td align="left"><?php echo $button ?>
	<input type="button" value="Group List" onClick="window.location='<?php echo $action['listgroups']; ?>'"><br /><br /></td></tr>
	</table>
	</td></tr>
</form>
</table>
