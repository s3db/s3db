		...
		<tr>
			<td>
				<table class="insidecontents" width="60%" align="center">
					<tr bgcolor="#99CCFF">
						<td align="center">Edit Group Account<input type="hidden" name="account_id" value="<?php echo $group_info['account_id'] ?>"><input type="hidden" name="account_lid" value="<?php echo $group_info['account_lid'] ?>"></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table class="insidecontents" width="60%"  align="center" border="0">
					<tr class="odd">
						...
						<td class="info"><?php echo '<input name="account_lid" value="'.$group_info['account_lid'].'"'.$disabled.'>&nbsp;';?></td>
	...
	<table class="bottom" width="100%"  align="center">
		<tr>
			<td>
				<table class="insidecontents" width="60%"  align="center">
					<tr>
						<td align="left"><input type="submit" name="updategroup" value="Update Group Account">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="back" value="Back to Group Account List" onClick="window.location='<?php echo $action['listgroups'] ?>'"><br /><br /></td>
					</tr>
				</table>
			</td>
		</tr>
