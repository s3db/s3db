<?php
	...
	//NOTE: Lena's: check if the user is allowed on the project
	//NOTE: Lena's - Create the values for the get of project_id and resource_id
	...
	//NOTE: Lena's - put this after the link: {get_proj_id}{get_res_id}
	...
	//NOTE: Lena's - Create the input type hidden with project_id and resource-id for submit buttons: {hidden_project}{hidden_entity} after every submit button
	...
	//NOTE: Lena's: create variable that holds project information and resource information to be available to all script; put this in every function that requires it - global $resource_info, $project_info;
