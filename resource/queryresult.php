...
if($_GET['num_per_page']=='') $num_per_page = '50';
else $num_per_page = $_GET['num_per_page'];
		...
		//echo $sql;
			while($db->next_record())
				...
				{$tpl->set_var('send_query_button', '<input type="button" value="Send result to '.$main_entity['entity'].'" onclick="window.location=\'queryresource_main_page.php{get_proj_id}&entity_id='.$class_info['main_resID'].'\'">');
					...
					#echo "<pre>";print_r ($_SESSION['result_list']);echo "</pre>";
...
<body onload="kill_me()">
	...
	<table class="resource_list" width="100%" align="center" border="0">
			<tr><td>
			<table class="query_resource" width="100%" border="0"><br />

			<tr><td class="" colspan="2">[<a href="javascript:history.go(-1)"><i>Back</i></a>]  
			&nbsp;&nbsp;&nbsp;
				<?php
				...
				<td style="font-size: smaller" align="right">Number of Results Per Page
				...
				#echo '&nbsp;&nbsp;&nbsp;&nbsp;Page '.$page.'</td></tr>';
				?>
			<tr><td class="nav_menu" colspan="3"><hr size="2" align="center" color="dodgerblue"></hr></td></tr>
			<tr><td colspan="2"><b>Total Matched Records: </b><?php echo count($instances)?></td>
			
			<td align="right"></td></tr>
			<tr><td class="nav_menu" colspan="3"><hr size="2" align="center" color="dodgerblue"></hr></td></tr>

			<tr><td class="message" colspan="3"></td></tr>
			<tr align="center">
				<td colspan="3"><table border="0px" width="100%" align="center" cellspacing="0" cellpadding="4" class="datagrid">
				<?php
				echo $datagrid;
				echo '<tr><td>'.$message_report.'</td></tr>';
