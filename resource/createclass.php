...
#RUN THE REST IN CASE USER HAS PERMISSION
	else
	{	
...
echo '
<form name="insertAcl" method="POST" action="'.$action['createresource'].'">';
...
?>
	...
	<tr bgcolor="#80BBFF"><td colspan="9" align="center">Manage permissions inherited from class</td></tr>
	<tr><td colspan="9" align="center">Use this section to manage permissions that individual users will have on the class and all dependencies. These will by default be inherited by every instance of the class.</td></tr>
