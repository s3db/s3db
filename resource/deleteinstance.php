...
exit;
	...
	?>
		<body onload="kill_me()">
		<?php
		echo '<form action="'.$action['deleteinstance'].'" method="post" autocomplete="on">';
		?>

		<table border="0">
			<tr>
				<?php 
				echo '<td><b>Deleting</b> resource #'.$instance_id.'</td><td align="right">&nbsp;<font color="red"><b>'.$instance_info['notes'].'</b></font></td>';
				?>
			</tr>
		...
		<table>
			...
			<tr>
				<?php
				echo '<td width="25" style="color: red" ></td>';
				echo '</tr><tr>';
				...
				echo '<td style="color: red" >'.$instance_info['notes'].'</td>';
