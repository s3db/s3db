...
?>	
<form name="queryresource" method="POST" action="<?php echo $action['querypage']; ?>&main_resID=<?php echo $_REQUEST['main_resID']; ?>&main_rule=<?php echo $_REQUEST['main_rule']; ?>" autocomplete="on">
				...
				<table class="query_resource" width="100%" border="0">
					...
					<tr>
						<td class="nav_menu" colspan="9" align="left">
							...
							<input type="button" name="listall" value="List all <?php echo $class_info['entity']; ?>" onClick="window.location='<?php echo $action['querypage']; ?>&listall=yes&main_resID=<?php echo $_REQUEST['main_resID']; ?>&main_rule=<?php echo $_REQUEST['main_rule']; ?>'">&nbsp;&nbsp;&nbsp;
							<input type="button" name="clearquery" value="Clear Query" onClick="window.location='<?php echo $action['querypage']; ?>'"><br /><br /><b />
						</td>
					</tr>
					<tr>
