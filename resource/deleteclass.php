...
<table class="middle" width="100%"  align="center">
	<tr><td>
		<table class="insidecontents" width="90%"  align="center" border="0">
			...
			<tr bgcolor="#80BBFF"><td align="center" colspan="8">Delete Class<input type="hidden" name="rule_id" value="7"></td></tr>
			<tr class="odd">
				<?php
			...
			<tr class="odd">
				<?php
				echo '<td width="5%"><b>'.$resource_info['collection_id'].'</b></td>
...
<table class="bottom" width="100%"  align="center">
	...
	<tr><td align="left">
		...
		echo '<form name= "deleterule" action = "'.$action['deleteclass'].'" method="POST">';
		echo '<input type="submit" name="delete" value="OK">&nbsp;&nbsp;&nbsp;&nbsp;';
		echo '<input type="button" name="cancel" value="Cancel" onClick="window.location=\''.$action['resource'].'\'"><br /><br /></td></tr>';
